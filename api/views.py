...
class GetRoom(APIView):
    ...
    def get(self, request, format=None):
        ...
        return Response({'Bad Request': 'Code not found in parameter'}, status=status.HTTP_400_BAD_REQUEST)
...
class CreateRoomView(APIView):
    ...
    def post(self, request, format=None):
        ...
        return Response(RoomSerializer({'Bad Request': 'Invalid data...'}, status=status.HTTP_400_BAD_REQUEST))
